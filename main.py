...
from db import createTable, extractMetadata, addBook, updateField, filterBooks, searchBook, updateBooks
...
def showInformation(book):
    ...
    keys = {
        ...
        'Серия': str(currentBook[11]),
        'Номер в серии книг': str(currentBook[12]),
